    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col">
          ...
          <br>
          <a href="<?php echo base_url('Daftarharga/viewadddaftarharga') ?>" class="btn btn-primary">Tambah Menu</a>
          <br><br>
          <div class="card">
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-info btn-sm" href="<?= base_url(); ?>Daftarjenis/viewVariabel_edit/<?= $value['id_harga']; ?>">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                        </a>
                        <a class="btn btn-danger btn-sm" href="<?= base_url(); ?>Daftarjenis/hapus/<?= $value['id_harga']; ?>">
